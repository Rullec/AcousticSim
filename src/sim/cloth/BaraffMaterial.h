...
public:
    ...
    virtual void Update(bool calc_energy = true, bool calc_fint = true, bool calc_stiffnessmatrix = true); // update deformation gra
...
protected:
    ...
    tEigenArr<tMatrix32d> mNLst, mFLst, mNprimeLst, mFprimeLst; // F = X * S * D_m^{-1}, N = S * D_m^{-1}
